...
public class ChannelActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public static void startChannelActivity(Activity context,String jsonArray){
        Intent intent=new Intent(context, ChannelActivity.class);
        intent.putExtra(RESULT_JSON_KEY,jsonArray);
        context.startActivityForResult(intent,REQUEST_CODE);
    }

    public static void startChannelActivity(Activity context, List<ChannelBean> list){
        Gson gson =new Gson();
    ...
    private void getListData(){
        ...
        listAll = new Gson().fromJson(jsonStr,new TypeToken<List<ChannelBean>>(){}.getType());
